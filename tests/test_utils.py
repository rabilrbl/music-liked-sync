...
def test_artist_matches_edge_cases():
    from music_liked_sync.utils import artist_matches
...
def test_track_similarity_with_duration():
    from music_liked_sync.utils import track_similarity
...
def test_best_match_with_candidates():
    from music_liked_sync.utils import best_match
...
def test_primary_search_artist():
    from music_liked_sync.utils import primary_search_artist
...
def test_truncate_query():
    from music_liked_sync.utils import truncate_query
    long_query = "a " * 150
...
def test_unique_by_key():
    from music_liked_sync.utils import unique_by_key
    tracks = [
...
def test_batched_errors():
    from music_liked_sync.utils import batched
    import pytest
...
def test_read_json_object_errors(tmp_path):
    from music_liked_sync.utils import read_json_object
